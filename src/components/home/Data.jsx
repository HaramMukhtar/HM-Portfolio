...
const Data = () => {
  return (
    <div className="home__data">
        ...
        Passionate developer and creative designer focused on building user-centric, real-world solutions. Thrives on solving problems, 
        learning continuously, and delivering work that balances functionality and visual impact.
        </p>
