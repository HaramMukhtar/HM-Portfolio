  ...
  return (
    <div className="home__data">
        ...
        <p className="home__description">
          Passionate developer, enhance problem-solving skills, and build scalable, user-friendly solutions.
          Thrives on learning industry best practices to deliver efficient, real-world applications..
        </p>
